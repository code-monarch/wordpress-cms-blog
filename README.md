...
9. Add following constants to `wp-config.php`
   ```php
   define('HEADLESS_SECRET', 'wwed8273djqdlqw');
   define('HEADLESS_URL', 'http://localhost:3000'); // http://localhost:3000 for local development
   define('GRAPHQL_JWT_AUTH_SECRET_KEY', 'joqidoq89328dwlxqkwl');
